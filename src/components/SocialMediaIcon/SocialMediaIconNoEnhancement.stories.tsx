...
export const Default = (args) => {
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex' }}>
        <SocialMediaIcon {...args} key="smi-icon-facebook" fontSize={fontSize} />
        <SocialMediaIcon {...args} key="smi-icon-twitter" fontSize={fontSize} />
        <SocialMediaIcon {...args} key="smi-icon-discord" fontSize={fontSize} />
      </div>
      <div style={{ display: 'flex' }}>
        <SocialMediaIcon
